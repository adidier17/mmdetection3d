...
from tools.dataset_converters import stratom3d_converter as stratom3d
...
def stratom3d_data_prep(
    ...
    """Prepare the info file for stratom3d dataset.
    ...
    Args:
        ...
        workers (int): Number of threads to be used.
    """
    stratom3d.create_stratom_info_file(
        data_root=root_path,
        sensor_name=sensor_name,
        num_points_feats=num_points_feats,
